...
from helper.lang_sam.models.gdino import GDINO
from helper.lang_sam.models.sam import SAM
from helper.lang_sam.models.utils import DEVICE
from typing import Union  # Import Union for type hinting

class LangSAM:
    def __init__(self, sam_type="sam2.1_hiera_large", sam_ckpt_path: Union[str, None] = None,gdino_ckpt_path: Union[str, None] = None, device=DEVICE):
        ...
        self.gdino = GDINO()
        self.gdino.build_model(gdino_ckpt_path,device=device)
