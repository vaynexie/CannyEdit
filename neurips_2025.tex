...
\kc{These training-free approaches are initially developed upon UNet-based diffusion models~\citep{hertz2022prompt, cao2023masactrl, tumanyan2023plug}, and has gradually shifted to leveraging more advanced rectified-flow-based multi-modal diffusion transformers (MM-DiTs)~\citep{rout2024semantic, wang2024taming, deng2024fireflow, tewel2025addit, zhu2025kv}.
The transformer architecture 
These methods primarily rely on injecting the source image's attention features (obtained via inversion \citep{deng2024fireflow,rout2024semantic,wang2024taming}) into the generation of the edited image, improving context fidelity.}
...
\textbf{Implementation Details.} We implement our method based on FLUX.1-[dev]~\cite{blackforest2024FLUX} and FLUX-controlnet-Canny~\cite{xlabsai2025fluxcontrolnet}. Most hyperparameters are consistent with FLUX-controlnet-Canny, using 50 denoising steps in total and guidance value as 4.0. For RICE-Bench, we resize images to resolution of 1024, while 512 in PIE-Bench. More implementation details including the use of machines and the detailed hyperparameters are provided in \textcolor{red}{Appendix~XX}.
...
According to Table~\ref{tab:rice-comparison}, 
...
\midrule
 &  & \multicolumn{2}{|c|}{w/o mask refinement} & \multicolumn{2}{c|}{mask refinement} & \multicolumn{2}{c}{N/A} \\
\midrule
...
\midrule
\multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}Variants \\ \arraybackslash of CC\end{tabular}} & w/o CC & 79.5/\underline{25.3} & 104.8 & 79.7/\underline{26.3} & 106.0 & 51.5/11.8 & 63.3 \\
 & Full CC & \textbf{90.8}/23.1 & \underline{113.9} & \textbf{93.4}/19.7 & \underline{113.1} & \textbf{68.1}/10.5 & \underline{78.6} \\
\midrule
\multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}Variants \\ \arraybackslash of Rx\end{tabular}} & local prompt only & \underline{85.1}/24.8 & 109.9 & \textbf{93.4}/10.2 & 103.6 & 58.9/\textbf{17.1} & 76.0 \\
