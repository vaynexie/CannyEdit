...
class ModelSpec:
    ...
    ae_path: Union[str,None]
    repo_id: Union[str,None]
    repo_flow: Union[str,None]
    repo_ae: Union[str,None]
    repo_id_ae: Union[str,None]
...
def load_flow_model2(name: str, device: Union[str , torch.device] = "cuda", hf_download: bool = True):
    # Loading Flux
    ckpt_path = configs[name].ckpt_path
    if (
        ckpt_path is None
...
def load_flow_model_quintized(name: str, device: Union[str , torch.device] = "cuda", hf_download: bool = True):
    # Loading Flux
    ckpt_path = configs[name].ckpt_path
    if (
        ckpt_path is None
